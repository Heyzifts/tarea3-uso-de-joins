-- Conocer los superpoderes de cada superheroe
...
-- De cada productor (publisher) mostrar cuantos hombres y mujeres(gender) hay
...
-- Mostrar todos los colores que componen a cada superheroe
...
-- Listar los atributos de cada supeheroe
...
-- Mostrar la calificacion de cada superhero
